...
echo ""
echo ""
read -p $'AM - T O O LA- BO - AMANJY - BASH - BENN ? (Y/N) :=>' option
echo""
echo""
echo""
if [[ $option == *'N'* ]]; then
...
echo -e $'\033[91m | \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/   |'
echo -e $'\033[91m |___________________________________________________|'
echo -e $'\e[1;32m\e[0m\e[1;32m Dabazandn... \n ======>  python2 \n ======>  git   \e[0m'
sleep 3
...
clear
echo -e '\e[96m Dabazandn |>> TkaYa BosTa  '
sleep 5
cd $HOME/ && rm -rf ddos-attack/ && git clone https://github.com/TheProfess0rr/The-Professorrr && cd The-Professorrr
cd The-Professorrr
chmod +x *
